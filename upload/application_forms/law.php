...
<div class="row d-flex justify-content-center" dir="rtl"> 
     <div class="card text-center my-4  col-md-4" style="background-color:rgba(0, 0, 0, 0.0); ">
          <div class="card-body">
            <img class="card-img-top" src="img/law/001.jpeg" height="600" style="border: solid #FFC107;">
            <br>
            <br>
...
محامي
   ...
   <div class="row d-flex justify-content-center" dir="rtl">   
        ...
        <div class="card text-center my-4  col-md-4" style="background-color:rgba(0, 0, 0, 0.0); ">
          <div class="card-body">
            <img class="card-img-top" src="img/law/002.jpeg" height="600" style="border: solid #FFC107;">
            <br>
            <br>
...
محامي
         ...
         <div class="card text-center my-4  col-md-4" style="background-color:rgba(0, 0, 0, 0.0); ">
          <div class="card-body ">
            <img class="card-img-top" src="img/law/003.jpeg" height="600" style="border: solid #FFC107;">
            <br>
            <br>
...
محامي
        ...
        <div class="card text-center my-4  col-md-4" style="background-color:rgba(0, 0, 0, 0.0); ">
          <div class="card-body ">
            <img class="card-img-top" src="img/law/004.jpeg" height="600" style="border: solid #FFC107;">
            <br>
            <br>
            <h5 class="btn btn-warning" style="font-size: 27px;">عبدالله علي العريني</h5>
            <p class="card-text text-warning" style="font-size: 23px;">
محامي
          </p>
          </div>
